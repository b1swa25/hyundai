...
export default function AddSuccessStoryModal({ isOpen, onClose }: AddSuccessStoryModalProps) {
            ...
            <div className="glass-card w-full max-w-2xl relative z-10 overflow-hidden border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] animate-in fade-in zoom-in duration-500 rounded-[2.5rem] max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-8 lg:p-12">
                    ...
                    <div className="flex justify-between items-start mb-10">
                        <div className="space-y-1">
                            <h2 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
                                <Sparkles className="w-6 h-6 text-hyundai-accent" />
                                Add Milestone
                            </h2>
                            <p className="text-white/40 text-xs font-medium uppercase tracking-widest">Digital Achievement Registry</p>
                        </div>
                        <button
                            onClick={onClose}
                    ...
                    <form ref={formRef} action={action} className="space-y-8">
                            ...
                            <div className="space-y-6 flex flex-col justify-center">
                                <div className="space-y-2.5">
                                    ...
                                    <input
                                        ...
                                        name="title"
                                        type="text"
                                        placeholder="e.g., Regional Excellence Award 2026"
                                ...
                                <div className="p-6 rounded-2xl bg-hyundai-accent/5 border border-hyundai-accent/10 space-y-2">
                                    <h4 className="text-[10px] font-black uppercase tracking-widest text-hyundai-accent">Pro Tip</h4>
                                    <p className="text-[10px] text-white/30 font-bold uppercase tracking-tight leading-relaxed">
                                        Use a high-quality landscape image for better visual impact on the main website.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Narrative Segment */}
                        <div className="space-y-2.5">
                            <label className="text-[10px] font-bold uppercase tracking-[0.2em] text-white/30 ml-1">Event Narrative</label>
                            <textarea
                                required
                                name="description"
                                rows={4}
                                placeholder="Describe the journey and significance of this milestone..."
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <button
                                ...
                                className="flex-[2] py-4 bg-hyundai-blue hover:bg-hyundai-blue/90 text-white rounded-2xl font-bold text-[10px] uppercase tracking-[0.4em] relative overflow-hidden group/btn disabled:opacity-50 transition-all border border-hyundai-accent/20 shadow-xl shadow-hyundai-blue/20"
                            >
                                ...
                                <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent via-white/10 to-transparent group-hover/btn:animate-shine" />
                            </button>
                        </div>
                    </form>
                </div>
